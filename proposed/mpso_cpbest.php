        ...
        for ($iteration = 0; $iteration <= $this->max_iteration-1; $iteration++) {
            ...
            if ($iteration > 0) {
                for ($i = 0; $i <= $this->swarm_size - 1; $i++) {
                    ...
                    $Pbest_simple = $Pbests[$iteration][$i]['xSimple'];
                    $Pbest_average = $Pbests[$iteration][$i]['xAverage'];
                    $Pbest_complex = $Pbests[$iteration][$i]['xComplex'];
                ...
                $SPbest = $Pbests[$iteration + 1];
                $CPbest1_index = array_rand($Pbests[$iteration + 1]);
                $CPbest2_index = array_rand($Pbests[$iteration + 1]);
                $CPbest1 = $Pbests[$iteration][$CPbest1_index];
                $CPbest2 = $Pbests[$iteration][$CPbest2_index];
                $counter = 0;
