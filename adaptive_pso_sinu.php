...
class MPUCWPSO
{
    ...
    function Main($dataset, $max_counter, $limit_percentage)
    {
        ##Generate Population
        ...
        while ($iterasi <= $this->MAX_ITERATION - 1) {
            //Inertia weight
            $w = $this->INERTIA_MIN + ((($this->INERTIA_MAX - $this->INERTIA_MIN) * $iterasi) / $this->MAX_ITERATION);
