...
class MPUCWPSO
{
    ...
    function Main($dataset)
    {
        ...
        //echo '<p>';
        //echo '<b>Partikel awal</b> <br>';
        //print_r($partikelAwal);
        //echo '<br>';
        //echo '<b>CPBest </b><br>';

        $SPbest = $this->SPBest($partikelAwal);  
        $GBest = $this->minimalAE($SPbest);
        ...
        while ($iterasi <= $this->MAX_ITERATION - 1) {
            ...
            if ($iterasi == 0) {
                ...
                //echo '<br>';
                $SPbest = $this->SPbest($partikel[$iterasi]);
                $GBest = $this->minimalAE($SPbest);
                //echo '<br>';
                //echo 'GBest: ';
                //print_r($SPbest);
...
for ($i = 0; $i <= 30 - 1; $i++) {
    ...
    foreach ($dataset as $key => $val) {
        ...
        echo $mpucwPSO->Main($dataset[$key])['size'].' ; '.$mpucwPSO->Main($dataset[$key])['ae'];
        echo '<br>';
    }
    echo '<p>';
}